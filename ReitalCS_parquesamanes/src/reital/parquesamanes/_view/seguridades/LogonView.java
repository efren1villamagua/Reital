...
public class LogonView extends JFrame {
	...
	private JButton getJButton() {
		if (jButton == null) {
			...
			jButton.setIcon(
					new ImageIcon(getClass().getResource("/reital/parquesamanes/resource/images/unlock24x24.png")));
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			...
			jLabel3.setIcon(new ImageIcon(
					getClass().getResource("/reital/parquesamanes/resource/images/bft_galleria-bgv-01.jpg")));
	...
	private void initialize() {
		...
		setSize(463, 410);
		setTitle("Reital - " + ParqueSamanesConstantes.LegalInfo.NOMBRE_COMERCIAL + " - Login - ["
