...
public class ClaseABMView extends javax.swing.JInternalFrame implements efren.util.gui.table.DataTablePanelListener, efren.util.gui.text.TextFieldExtListener,
	...
	public void dataFetch() {
		...
		try {
			...
			String s = " SELECT OID, NOMBRE AS NOMBRE, PAQUETE AS PACKAGE, TIMESTAMP " + " FROM " + SystemProperties.SCHEMA_SEGURIDADES + "." + "CLASE ";
			if (porNombre)
