...
public class OpcionTreeTable extends JTable {

    public OpcionTreeModel2 opcionModel = null;

    /** A subclass of JTree. */
    protected TreeTableCellRenderer cellRenderer;

    public OpcionTreeTable() {
        this(new OpcionTreeModel2());
    }

    public OpcionTreeTable(TreeTableModel treeTableModel) {
        super();

        if (treeTableModel instanceof OpcionTreeModel2)
            this.opcionModel = (OpcionTreeModel2) treeTableModel;
        ...
        OpcionTreeCellRenderer opcionRenderer = new OpcionTreeCellRenderer();
...
//              CAMBIO_EFREN 2006-08-31 dtcr.setBackgroundSelectionColor(UIManager.getColor("Table.selectionBackground"));
        ...
        public void setRowHeight(int rowHeight) {
            if (rowHeight > 0) {
                super.setRowHeight(rowHeight);
                if (OpcionTreeTable.this != null && OpcionTreeTable.this.getRowHeight() != rowHeight) {
                    OpcionTreeTable.this.setRowHeight(getRowHeight());
                }
            }
        }
        ...
        public void setBounds(int x, int y, int w, int h) {
            super.setBounds(x, 0, w, OpcionTreeTable.this.getHeight());
        }
