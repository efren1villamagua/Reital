...
public abstract class PerfilOpcionAbstractTreeTableModel implements TreeTableModel {
    protected Object root;

    protected EventListenerList listenerList = new EventListenerList();

    public PerfilOpcionAbstractTreeTableModel(Object root) {
        this.root = root;
    }
    ...
    public boolean isCellEditable(Object node, int column) {
        return column == 0 || column == 2 || column == 3 || column == 4 || column == 5 || column == 6 || column == 7 || column == 8;
    }
