...
public class OpcionTreeCellRenderer extends DefaultTreeCellRenderer {
	 ...
	 * 
	 */
	public OpcionTreeCellRenderer() {
		super();
	}
	
	//...
	public Component getTreeCellRendererComponent(JTree tree, Object value, boolean sel, boolean expanded, boolean leaf, int row, boolean hasFocus) {
	    if (value instanceof OpcionTreeModel2.OpcionNode) {
			SecOpcion o = ((OpcionTreeModel2.OpcionNode) value).getOpcion();
		    ...
		    if (o.getOid() == OpcionTreeModel2.SISTEMA_SEGURIDADES_META_OID)
