 ...
 */
public class SecOpcion extends EntityObjectSeguridades implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5232292498841386531L;
...
/**
 * SecOption constructor comment.
 */
public SecOpcion() {
	super();
	this.setEsMenu(false);
...
public java.lang.Boolean getOP_todo() {
	...
	public void setIconName(String anIconName) {
		this.iconName = anIconName;
	}
