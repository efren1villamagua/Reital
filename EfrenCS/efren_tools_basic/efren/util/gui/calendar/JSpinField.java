...
public JSpinField() {
    ...
    scrollBar.setPreferredSize(
        new Dimension(scrollBar.getPreferredSize().width, textField.getPreferredSize().height));
    ...
    constraintsTextField.weighty = 0.0;
    constraintsTextField.ipady = 0;
    constraintsTextField.insets = new java.awt.Insets(1, 1, 1, 1);
    add(textField, constraintsTextField);
    ...
    constraintsScrollBar.insets = new java.awt.Insets(1, 1, 1, 1);
